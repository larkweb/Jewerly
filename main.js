...
function sendWhatsAppMessage(message) {
  var phoneNumber = "+573024618878";
  var url = "https://api.whatsapp.com/send?phone=" + phoneNumber + "&text=" + encodeURIComponent(message);
  window.open(url);
}
document.addEventListener("DOMContentLoaded", function() {
  var exploreNowButton = document.querySelector(".btn");
  var productsSection = document.getElementById("products");

  exploreNowButton.addEventListener("click", function(event) {
      event.preventDefault(); // Evita que el enlace siga su comportamiento predeterminado de redireccionar
